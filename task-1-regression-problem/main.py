...
if __name__ == "__main__":
    ...
    M_values = range(0, 7)
    w, train_err, val_err = model_selection(data['x_train_50'], data['y_train_50'], data['x_val_20'], data['y_val_20'],
                                            M_values)
    M = np.shape(w)[0] - 1
    y_model = polynomial(x_plot, w)
    ...
    w, train_err, val_err, best_lambda = regularized_model_selection(data['x_train_50'], data['y_train_50'],
